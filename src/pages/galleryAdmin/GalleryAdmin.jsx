...
function GalleryAdmin() {
  ...
  useEffect(() => {// se creo un hook de tipo useEffect, para actualizar mi productsArray
    const getProducts = async () => { 
      try {
        const response = await fetch("http://localhost:4000/api/products");// se hizo una peticion al backend para pedir datos.
